...
class Settings {
    ...
    return `
      <div class="main-content">
        ...
        <div class="settings-section">
          ...
          <p class="settings-note">Allow microphone access for voice recording features.</p>
          
          <div class="settings-item">
            <button class="btn btn-primary btn-full" id="mic-permission-btn">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  attachEventListeners() {
    ...
    if (micPermissionBtn) {
      micPermissionBtn.addEventListener('click', () => this.handleMicPermission())
    }
  }
  ...
  async handleMicPermission() {
    try {
      ...
      if (error.name === 'NotAllowedError' || error.name === 'PermissionDeniedError') {
        this.showError('Microphone access denied. Please allow access in your browser settings.')
      } else {
